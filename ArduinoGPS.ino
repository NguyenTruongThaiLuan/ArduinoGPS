...
static const int simRX = 5, simTX = 2;
...
String ipAddress = "192.168.1.189"; //this is the ip address of our server - e.g. "123.123.123.123"
String APN = "internet"; //check your Internet provider's website for the APN e.g. "internet"
